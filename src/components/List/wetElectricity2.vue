...
export default {
  ...
  methods: {
    ...
    websocketonmessage(e) {
      ...
      // console.log(redata);
      this.graphitization = redata.runTimeAndVA.source3;
      this.dataProcessing();
    },
    websocketsend(Data) {
      //数据发送
    ...
    dataProcessing() {
      ...
      let xData = [],
        ...
        eleCurrent = [],
        runningTime = [];
      this.graphitization.forEach((item) => {
    ...
    initRadar() {
      let myChart = this.$echarts.init(document.getElementById("WetElectricity2")); //初始化实例
      let option = {
